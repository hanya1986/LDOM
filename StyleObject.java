 ...
 * Revision 1.4  2014/10/02 03:01:33  yc7816
 ...
 * @Name: Yihao Cheng
 * An object that modifies the style of the font used to display the text within its wrapped DocObject
 */
public class StyleObject  implements DocObject {
	/**
	 * Declare the List into ArrayList and create an object.
	 * Create an style object
	 */
	TextStyle style;
	DocObject dObj;
	...
	public String generateHTML(){
		...
		for(int i = 0; i <child.size(); i++){
			words = words + child.get(i).generateHTML();
		}
		if(style == TextStyle.bold){
		    return "<span style = \"font-weight: bold\">" + words +"</span>";	
		}else{
			return "<span style = \"font-weight: italic\">" + words +"</span>";
		 }
	}
